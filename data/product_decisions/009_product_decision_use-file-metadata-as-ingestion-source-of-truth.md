---
{
  ...
  "title": "Use file metadata as ingestion source of truth",
  "project": "Platform",
...
# Product Decision: Use file metadata as ingestion source of truth
...
## Decision
Use file metadata as ingestion source of truth.
