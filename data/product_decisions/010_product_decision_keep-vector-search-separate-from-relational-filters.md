---
{
  ...
  "title": "Keep vector search separate from relational filters",
  "project": "Platform",
...
# Product Decision: Keep vector search separate from relational filters
...
## Decision
Keep vector search separate from relational filters.
