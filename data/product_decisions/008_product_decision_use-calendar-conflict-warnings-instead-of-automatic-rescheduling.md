---
{
  ...
  "title": "Use calendar conflict warnings instead of automatic rescheduling",
  "project": "Scheduling",
...
# Product Decision: Use calendar conflict warnings instead of automatic rescheduling
...
## Decision
Use calendar conflict warnings instead of automatic rescheduling.
