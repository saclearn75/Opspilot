---
{
  ...
  "title": "Notification strategy working session",
...
# Meeting Notes: Notification strategy working session
...
## Decisions
- Treat notifications as a project memory area.
...
## Action items
- Product: define demo questions for notifications.
