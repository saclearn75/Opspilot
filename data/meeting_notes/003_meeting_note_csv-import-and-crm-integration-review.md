---
{
  ...
  "title": "CSV import and CRM integration review",
...
# Meeting Notes: CSV import and CRM integration review
...
## Decisions
- Treat integrations as a project memory area.
...
## Action items
- Product: define demo questions for integrations.
