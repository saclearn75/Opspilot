---
{
  ...
  "title": "Duplicate escalation alerts sent to regional managers",
  ...
  "customer": "CedarCare Clinics",
  "status": "resolved",
  "priority": "medium"
}
---

# Support Ticket: Duplicate escalation alerts sent to regional managers

## Customer
CedarCare Clinics

## Problem
A user reported: duplicate escalation alerts sent to regional managers. The issue affects the notifications workflow and may connect to previous feedback around notifications, customer_escalations.
